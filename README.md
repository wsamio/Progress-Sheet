...
|:--------:|:----------:|----------------|---------------|
| Python Data-camp | 1.4 hrs | <li><ul>[Dictionaries](https://shorturl.at/kxMOP)</li> </ul>| |

## February 15, 2023

|    Activity    | Time Spent | Things Learned        | Problem Faced                                                                                |
|:--------------:|:----------:|-----------------------|----------------------------------------------------------------------------------------------|
| Progress Sheet |    2 hrs   | <ul><li>Track Sheet</li><li>Functions</li><ul> | <ul><li>[x] ~~Add to do list~~</li> <li>[x] ~~How to add same formula to the whole column~~</li></ul>                      |
