...
| Andrew Ng | 2.3 hrs | <ul><li>Supervised learning process</li><li>Model function</li><li>Univariate linear regression</li><li>[Straight line through the data lab](https://shorturl.at/kxMOP)</li></ul> | <ul><li> [ ] Linear regression model training and estimated target</li></ul> |
